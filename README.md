...
2. **Build the concept's mini-project** in **[`projects/`](./projects/)** — there's a simple, scrappy project for *every* buzzword below.
3. Note the **"where it's used"** section; that's the FDE lens (when to reach for it).
4. At the end of each Part, hit the ✅ **checkpoint** and its **🛠️ Build-it** link — if you can do it, move on.
5. Finish with the **[capstone projects](#-capstone-projects)** to prove you can do the job.
...
> &nbsp; · &nbsp; 🛠️ **Build it:** [Part I projects](./projects/part1-foundations.md)
...
> &nbsp; · &nbsp; 🛠️ **Build it:** [Part II projects](./projects/part2-talking-to-models.md)
...
> &nbsp; · &nbsp; 🛠️ **Build it:** [Part III projects](./projects/part3-rag.md)
...
> &nbsp; · &nbsp; 🛠️ **Build it:** [Part IV projects](./projects/part4-customizing.md)
...
> &nbsp; · &nbsp; 🛠️ **Build it:** [Part V projects](./projects/part5-agents.md)
...
> &nbsp; · &nbsp; 🛠️ **Build it:** [Part VI projects](./projects/part6-production.md)
...
> &nbsp; · &nbsp; 🛠️ **Build it:** [Part VII projects](./projects/part7-fde.md)
...
> 🛠️ **Build it:** [Appendix projects](./projects/appendix-frontier.md)

---

## 🎓 Capstone projects

Prove you can do the job — each forces you to combine the parts. **Full briefs, requirements,
and grading rubrics are in [`projects/capstones.md`](./projects/capstones.md).**

| Level | Project | Concepts exercised |
|-------|---------|--------------------|
| 🟢 **Beginner** | "Chat with your docs" bot **with citations** + a 20-question eval set | Parts I–III |
| 🟡 **Intermediate** | Support **agent** with tools, guardrails, observability & a red-team pass | Parts I–VI |
| 🔴 **Advanced** | **End-to-end FDE simulation:** discovery → scope → POC → evals → cost plan → risk pre-mortem → handoff | All parts + [FDE](./fde/) + [system design](./llm-system-design/) |

> 💡 The advanced capstone is the real test: it's not "can you use RAG," it's "can you take a
> vague problem and ship value" — the actual FDE job. → **[Open the capstone briefs](./projects/capstones.md)**

> 🛠️ Every concept also has its **own bite-sized project** — browse the **[projects index](./projects/)**.
...
├── projects/               # a hands-on project per concept + 3 capstones
│
...
├── mcp/
├── evaluation/ · guardrails/ · hallucination/ · red-teaming/ · observability/
├── synthetic-data/ · constitutional-ai/ · model-routing/ · structured-output/
├── long-context/ · semantic-caching/ · model-merging/ · mechanistic-interpretability/
├── world-models/ · federated-learning/
└── fde/ · llm-system-design/     # the FDE craft
```
